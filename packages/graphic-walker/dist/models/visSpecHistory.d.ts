...
export declare const performers: {
    ...
    readonly moveField: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_3: number, args_4: number | null) => VisSpecWithHistory;
    readonly cloneField: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_3: number, args_4: string, args_5: number | null) => VisSpecWithHistory;
    readonly createBinlogField: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: "bin" | "log2" | "log10" | "binCount" | "log", args_3: string, args_4: number) => VisSpecWithHistory;
    readonly appendFilter: (data: VisSpecWithHistory, args_0: number, args_1: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_2: number, args_3: null) => VisSpecWithHistory;
    readonly modFilter: (data: VisSpecWithHistory, args_0: number, args_1: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_2: number) => VisSpecWithHistory;
    readonly writeFilter: (data: VisSpecWithHistory, args_0: number, args_1: IFilterRule | null) => VisSpecWithHistory;
    ...
    readonly setLayout: (data: VisSpecWithHistory, args_0: (["size", {
        ...
        width: number;
        height: number;
    }] | ["scale", import("../interfaces").IConfigScaleSet | undefined] | ["format", {
        numberFormat?: string | undefined;
        timeFormat?: string | undefined;
        normalizedNumberFormat?: string | undefined;
    }] | ["background", string | undefined] | ["stack", import("../interfaces").IStackMode] | ["resolve", {
        x?: boolean | undefined;
        y?: boolean | undefined;
    ...
    readonly createDateDrillField: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: "year" | "quarter" | "month" | "week" | "day" | "hour" | "minute" | "second" | "iso_year" | "iso_week", args_3: string, args_4: string, args_5: string | undefined, args_6: number | undefined) => VisSpecWithHistory;
    readonly createDateFeatureField: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: "year" | "quarter" | "month" | "week" | "day" | "hour" | "minute" | "second" | "iso_year" | "iso_week" | "weekday" | "iso_weekday", args_3: string, args_4: string, args_5: string | undefined, args_6: number | undefined) => VisSpecWithHistory;
    readonly changeSemanticType: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: ISemanticType) => VisSpecWithHistory;
    readonly setFilterAggregator: (data: VisSpecWithHistory, args_0: number, args_1: "" | IAggregator) => VisSpecWithHistory;
    readonly addFoldField: (data: VisSpecWithHistory, args_0: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_1: number, args_2: "rows" | "columns" | "size" | "color" | "text" | "shape" | "radius" | "opacity" | "theta" | "details" | "dimensions" | "measures" | "longitude" | "latitude" | "geoId", args_3: number, args_4: string, args_5: number | null) => VisSpecWithHistory;
    ...
    readonly replaceWithNLPQuery: (data: VisSpecWithHistory, args_0: string, args_1: string) => VisSpecWithHistory;
};
